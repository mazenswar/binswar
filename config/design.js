...
export const palettes = [
	...
	},
	{
		id: "deep-violet",
		label: "Deep Violet",
		description: "Noir black & rich purple",
		group: "dark",
		swatches: ["#7c5cbf", "#0f0f12", "#c4b5e8"],
	},
	{
		id: "slate-mauve",
		label: "Slate Mauve",
		description: "Dark grey & muted purple",
		group: "dark",
		swatches: ["#8b6fae", "#141417", "#d4c5e8"],
	},
	{
		id: "obsidian-gold",
		label: "Obsidian Gold",
		description: "Pure black & warm gold",
		group: "dark",
		swatches: ["#c9963a", "#0a0a0a", "#e8d5a8"],
	},
];
...
export const fontPairings = [
	...
	},
	{
		id: "expressive",
		label: "Expressive",
		description: "DM Serif Display + Lexend",
		heading: "--font-bold-heading",
		body: "--font-warm-body",
	},
	{
	...
	},
	{
		id: "binswar",
		label: "Binswar",
		description: "DM Serif Display + Plus Jakarta Sans",
		heading: "--font-binswar-heading",
		body: "--font-binswar-body",
	},
];
